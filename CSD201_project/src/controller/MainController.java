...
public class MainController {
    ...
    private HashMap<String, InventoryBatchTemp> inventoryBatchMap;
    private HashMap<String, String> skuToBatchId;
    private List<InventoryBatchTemp> loadedInventoryBatches;
    ...
    private final StorageHandler<InventoryBatchTemp, List<InventoryBatchTemp>> inventoryStorage;
